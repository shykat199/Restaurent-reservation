                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="first_name" name="first_name"
                                               ...
                                               rounded-md py-2 px-3 text-base leading-normal transition duration-150
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="text" id="last_name" name="last_name"
                                               ...
                                               py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5"/>
                                    </div>
                                    @error('last_name')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <input type="datetime-local" id="res_date" name="res_date"
                                               min="{{ optional($min_date)->format('Y-m-d\TH:i:s') }}"
                                               max="{{ optional($max_date)->format('Y-m-d\TH:i:s') }}"
                                               value="{{ $reservation ? optional($reservation->res_date)->format('Y-m-d\TH:i:s') : '' }}"
                                               class="block w-full appearance-none bg-white border border-gray-400 rounded-md
                                           py-2 px-3 text-base leading-normal transition
                                           duration-150 ease-in-out sm:text-sm sm:leading-5"/>
                                    </div>
                                    <span class="text-xs">Please choose the time between 2:00-8:00.</span>
                                    @error('res_date')
                                    <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
                                </div>
