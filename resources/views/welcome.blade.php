                ...
                @foreach($specialMenus as $specialMenu)
                    ...
                    <div class="max-w-xs mx-4 mb-2 rounded-lg shadow-lg">
                        <img class="w-full h-48"
                             src="{{\Illuminate\Support\Facades\Storage::url($specialMenu->image)}}"
                             alt="Image"/>
                        <div class="px-6 py-4">
                            @foreach($specialMenu->categories as $category)
                                <div class="mb-2" style="display: inline-block; flex-direction: row;">
                                <span class=" px-4 py-0.5 text-sm bg-red-500 rounded-full text-red-50">
                                    {{$category->name}}
                                </span>
                                </div>
                            @endforeach
                            <h4 class="mb-3 text-xl font-semi-bold tracking-tight text-green-600 uppercase">
                                {{$specialMenu->name}}
                            </h4>
                        ...
                        <div class="flex items-center justify-between pb-3 ml-4">
                            <span class="text-xl text-green-600 ml-2">${{$specialMenu->price}}</span>
                        </div>
                    </div>
